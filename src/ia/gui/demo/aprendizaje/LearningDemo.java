package ia.gui.demo.aprendizaje;
...
import ia.core.aprendizaje.aprendices.DecisionListLearner;
import ia.core.aprendizaje.aprendices.DecisionTreeLearner;
...
import ia.core.aprendizaje.reforzado.agente.PassiveADPAgent;
import ia.core.aprendizaje.reforzado.agente.PassiveTDAgent;
import ia.core.aprendizaje.reforzado.agente.QLearningAgent;
import ia.core.aprendizaje.reforzado.agente.ReinforcementAgent;
...
public class LearningDemo {
	...
	private static void output_utility_learning_rates(
		...
		cwe.agregarAgent(reinforcementAgent);
