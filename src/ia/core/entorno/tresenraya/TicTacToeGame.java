package ia.core.entorno.tresenraya;
 ...
 * 
 */
public class TicTacToeGame implements Game<TicTacToeState, UbicacionXY, String> {
	...
	@Override
	public List<UbicacionXY> getActions(TicTacToeState state) {
		return state.getUnMarkedPositions();
	}

	@Override
	public TicTacToeState getResult(TicTacToeState state, UbicacionXY action) {
