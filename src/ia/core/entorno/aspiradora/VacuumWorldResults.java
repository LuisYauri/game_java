...
import ia.core.busqueda.nodeterministico.ResultsFunction;
...
public class VacuumWorldResults implements ResultsFunction {
	 ...
	 * @param agent
	 */
	public VacuumWorldResults(Agente agent) {
		this.agent = agent;
	}
	 ...
	 */
	@Override
	public Set<Object> results(Object state, Accion action) {
		// setup
