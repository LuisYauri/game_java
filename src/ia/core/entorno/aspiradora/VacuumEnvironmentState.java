 ...
 * @author Andrew Brown
 */
public class VacuumEnvironmentState implements EstadoEntorno,
		FullyObservableVacuumEnvironmentPercept {

	private Map<String, VacuumEnvironment.LocationState> state;
	private Map<Agente, String> agentLocations;
	...
	public VacuumEnvironmentState() {
		...
		agentLocations = new LinkedHashMap<Agente, String>();
	}
	 ...
	 * @param location
	 */
	public void setAgentLocation(Agente a, String location) {
