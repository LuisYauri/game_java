package ia.core.logica.proposicional.agente;
 ...
 */
public abstract class KBAgent extends AgenteAbstracto {
	// persistent: KB, a knowledge base
	...
	public Accion ejecutar(Percepcion percept) {
		...
		// action &lt;- ASK(KB, MAKE-ACTION-QUERY(t))
		Accion action = ask(KB, makeActionQuery(t));
	...
	public abstract Sentence makePerceptSentence(Percepcion percept, int t);
	...
	public abstract Sentence makeActionSentence(Accion action, int t);
	...
	public abstract Accion ask(KnowledgeBase KB, Sentence actionQuery);
}
